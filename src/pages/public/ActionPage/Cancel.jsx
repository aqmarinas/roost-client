  ...
  if (booking.status === "Cancelled" || booking.status === "Rejected") {
    return (
      <PublicLayout>
        <div className="max-w-xl mx-auto text-center mt-12">
          <AlertCircle className="w-12 h-12 text-red-500 mx-auto mb-4" />
          <h1 className="text-2xl font-semibold mb-2">Booking Already {booking.status} </h1>
            ...
            {isCancelled ? (
              <Card>
                <CardHeader className="text-center">
                  ...
                  <CardDescription>Your booking has been successfully cancelled. A confirmation email has been sent to your registered email address.</CardDescription>
                </CardHeader>
