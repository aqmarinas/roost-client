...
function Sidebar({ side = "left", variant = "sidebar", collapsible = "icon", className, children, ...props }) {
  ...
  if (isMobile) {
    return (
      <Sheet
        open={state === "collapsed" ? openMobile : false}
        // open={openMobile}
    ...
    >
      ...
      >
        <div
          ...
          className="bg-white px-3 py-4 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
